...
foto_ofer_b2020$NOMMUNI[which(foto_ofer_b2020$NOMMUNI=="Ametlla del Vallès (L´)")] <- "l'Ametlla del Vallès"
foto_ofer_b2020$NOMMUNI[which(foto_ofer_b2020$NOMMUNI=="Ampolla (L´)")] <- "l'Ampolla"
foto_ofer_b2020$NOMMUNI[which(foto_ofer_b2020$NOMMUNI=="Arboç (L´)")] <- "l'Arboç"
foto_ofer_b2020$NOMMUNI[which(foto_ofer_b2020$NOMMUNI=="Aldea (L´)")] <- "l'Aldea"
foto_ofer_b2020$NOMMUNI[which(foto_ofer_b2020$NOMMUNI=="Espluga de Francolí (L´)")] <- "l'Espluga de Francolí"
...
foto_ofer_b2020$NOMMUNI[which(foto_ofer_b2020$NOMMUNI=="Pla del Penedès (El)")] <- "el Pla del Penedès"
foto_ofer_b2020$NOMMUNI[which(foto_ofer_b2020$NOMMUNI=="Pont de Bar (El)")] <- "el Pont de Bar"
foto_ofer_b2020$NOMMUNI[which(foto_ofer_b2020$NOMMUNI=="Far d´Empordà (El)")] <- "el Far d'Empordà"
foto_ofer_b2020$NOMMUNI[which(foto_ofer_b2020$NOMMUNI=="Perelló (El)")] <- "el Perelló"
foto_ofer_b2020$NOMMUNI[which(foto_ofer_b2020$NOMMUNI=="Pallaresos (Els)")] <- "els Pallaresos"
foto_ofer_b2020$NOMMUNI[which(foto_ofer_b2020$NOMMUNI=="Alamús (Els)")] <- "els Alamús"
...
foto_ofer_b2020$NOMMUNI[which(foto_ofer_b2020$NOMMUNI=="Riera de Gaià (La)")] <- "la Riera de Gaià"
foto_ofer_b2020$NOMMUNI[which(foto_ofer_b2020$NOMMUNI=="Seu d´Urgell (La)")] <- "la Seu d'Urgell"
foto_ofer_b2020$NOMMUNI[which(foto_ofer_b2020$NOMMUNI=="Roca del Vallès (La)")] <- "la Roca del Vallès"
foto_ofer_b2020$NOMMUNI[which(foto_ofer_b2020$NOMMUNI=="Palma de Cervelló (La)")] <- "la Palma de Cervelló"
...
foto_ofer_b2020$NOMMUNI[which(foto_ofer_b2020$NOMMUNI=="Bisbal d´Empordà (La)")] <- "la Bisbal d'Empordà"
foto_ofer_b2020$NOMMUNI[which(foto_ofer_b2020$NOMMUNI=="Tallada d´Empordà (La)")] <- "la Tallada d'Empordà"
...
foto_ofer_b2020$NOMMUNI[which(foto_ofer_b2020$NOMMUNI=="Pobla de Cérvoles (La)")] <- "la Pobla de Cérvoles"
...
foto_ofer_b2020$NOMMUNI[which(foto_ofer_b2020$NOMMUNI=="Vall de Boí (La)")] <- "la Vall de Boí"
foto_ofer_b2020$NOMMUNI[which(foto_ofer_b2020$NOMMUNI=="Granada (La)")] <- "la Granada"
foto_ofer_b2020$NOMMUNI[which(foto_ofer_b2020$NOMMUNI=="Nou de Gaià (La)")] <- "la Nou de Gaià"
...
foto_ofer_b2020$NOMMUNI[which(foto_ofer_b2020$NOMMUNI=="Pobla de Montornès (La)")] <- "la Pobla de Montornès"
foto_ofer_b2020$NOMMUNI[which(foto_ofer_b2020$NOMMUNI=="Galera (La)")] <- "la Galera"
foto_ofer_b2020$NOMMUNI[which(foto_ofer_b2020$NOMMUNI=="Guingueta d´Àneu (La)")] <- "la Guingueta d'Àneu"
...
foto_ofer_b2020$NOMMUNI[which(foto_ofer_b2020$NOMMUNI=="Bisbal del Penedès (La)")] <- "la Bisbal del Penedès"
...
foto_ofer_b2020$NOMMUNI[which(foto_ofer_b2020$NOMMUNI=="Sénia (La)")] <- "la Sénia"
...
foto_ofer_b2020$NOMMUNI[which(foto_ofer_b2020$NOMMUNI=="Sentiu de Sió (La)")] <- "la Sentiu"
...
foto_ofer_b2020$NOMMUNI[which(foto_ofer_b2020$NOMMUNI=="Franqueses del Vallès (Les)")] <- "les Franqueses del Vallès"
...
foto_ofer_b2020$NOMMUNI[which(foto_ofer_b2020$NOMMUNI=="Masies de Voltregà (Les)")] <- "les Masies de Voltregà"
...
foto_ofer_b2020$NOMMUNI[which(foto_ofer_b2020$NOMMUNI=="Sant Carles de la Ràpita")] <- "la Ràpita"
...
foto_ofer_b2020$NOMMUNI<-gsub("L'Ametlla del Vallès","l'Ametlla del Vallès",as.character(foto_ofer_b2020$NOMMUNI))
...
foto_ofer_b2020$NOMMUNI[which(foto_ofer_b2020$NOMMUNI=="Alàs I Cerc")] <- "Alàs i Cerc"
...
foto_ofer_b2020$NOMMUNI[which(foto_ofer_b2020$NOMMUNI=="Les Franqueses del Vallès")] <- "les Franqueses del Vallès"
foto_ofer_b2020$NOMMUNI[which(foto_ofer_b2020$NOMMUNI=="Les Masies de Roda")] <- "les Masies de Roda"
foto_ofer_b2020$NOMMUNI[which(foto_ofer_b2020$NOMMUNI=="Les Masies de Voltregà")] <- "les Masies de Voltregà"
...
foto_ofer_b2020$district[which(foto_ofer_b2020$district=="Sants - Montjuïc")] <- "Sants-Montjuïc"
foto_ofer_b2020$district[which(foto_ofer_b2020$district=="Sarrià - Sant Gervasi")] <- "Sarrià-Sant Gervasi"
foto_ofer_b2020$district[which(foto_ofer_b2020$district=="Horta - Guinardò")] <- "Horta-Guinardò"
foto_ofer_b2020$district[which(foto_ofer_b2020$district=="Sants Montjuïc")] <- "Sants-Montjuïc"
foto_ofer_b2020$district[which(foto_ofer_b2020$district=="Sarrià Sant Gervasi")] <- "Sarrià-Sant Gervasi"
foto_ofer_b2020$district[which(foto_ofer_b2020$district=="Horta Guinardó")] <- "Horta-Guinardò"
...
test111_20 <- merge(x=foto_ofer_b2020, y=mitjana_surface_o_dist, by.x=c("property_id","district", "mes"), 
...
mitjana_price_o_dist <- aggregate(x = test111_20$price,    
                                  by = list(foto_ofer_b2020$property_id, 
                                            foto_ofer_b2020$district, 
                                            foto_ofer_b2020$mes),             
                                  FUN = mean)                           
...
test111_20_pm_ud <- merge(x=test11a_20_fd, y=test11b_20_ld, by.x=c("property_id","district", "mes"), 
                          by.y=c("property_id","district", "mes"))
...
test111_20_pm_ud_dp <- merge(x=test111_20_pm_ud, y=test11b_20_dp, by.x=c("property_id","district", "mes"), 
                             by.y=c("property_id","district", "mes"))
...
test_b2020_f <- left_join(test_b2020_f, preu_mitjana_mes_2020)%>%
  distinct(property_id, district, mes, .keep_all =TRUE)
test_b2020_f <- left_join(test_b2020_f, counting_dist_2020)%>%
  distinct(property_id, district, mes, .keep_all =TRUE)
...
na_date <- as.data.frame(ddply(test_b2020_f, .(property_id), summarize, nNA=sum(is.na(date_posting_calcul))))
...
library(xlsx)
write_csv(test_b2020_f, "/Users/wemigliari/Documents/Pós-Doutorado & Doutorado/Pós-Doc/Observatori_Metropolita/Dades/2020_Fotocasa_Oferta/tractament_foto_oferta_b2020.csv")
