...
filenames11 <- list.files("/Users/wemigliari/Documents/Pós-Doutorado & Doutorado/Pós-Doc/Observatori_Metropolita/Dades/2021_Habitaclia_demanda/dt=20211001", pattern="*.snappy.parquet", full.names=TRUE)
...
filenames12 <- list.files("/Users/wemigliari/Documents/Pós-Doutorado & Doutorado/Pós-Doc/Observatori_Metropolita/Dades/2021_Habitaclia_demanda/dt=20211001", pattern="*.snappy.parquet", full.names=TRUE)
