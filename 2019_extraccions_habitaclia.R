...
filenames11 <- list.files("/Users/wemigliari/Documents/Pós-Doutorado & Doutorado/Pós-Doc/Observatori_Metropolita/Dades/2019_Habitaclia_demanda/dt=20191101", pattern="*.snappy.parquet", full.names=TRUE)
...
filenames12 <- list.files("/Users/wemigliari/Documents/Pós-Doutorado & Doutorado/Pós-Doc/Observatori_Metropolita/Dades/2019_Habitaclia_demanda/dt=20191201", pattern="*.snappy.parquet", full.names=TRUE)
