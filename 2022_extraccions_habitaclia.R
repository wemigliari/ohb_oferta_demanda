...
filenames <- list.files("/Users/wemigliari/Documents/Pós-Doutorado & Doutorado/Pós-Doc/Observatori_Metropolita/Dades/2022_Habitaclia_demanda/dt=20220101", pattern="*.snappy.parquet", full.names=TRUE)
...
filenames2 <- list.files("/Users/wemigliari/Documents/Pós-Doutorado & Doutorado/Pós-Doc/Observatori_Metropolita/Dades/2022_Habitaclia_demanda/dt=20220201", pattern="*.snappy.parquet", full.names=TRUE)
...
filenames3 <- list.files("/Users/wemigliari/Documents/Pós-Doutorado & Doutorado/Pós-Doc/Observatori_Metropolita/Dades/2022_Habitaclia_demanda/dt=20220301", pattern="*.snappy.parquet", full.names=TRUE)
...
filenames4 <- list.files("/Users/wemigliari/Documents/Pós-Doutorado & Doutorado/Pós-Doc/Observatori_Metropolita/Dades/2022_Habitaclia_demanda/dt=20220401", pattern="*.snappy.parquet", full.names=TRUE)
...
filenames5 <- list.files("/Users/wemigliari/Documents/Pós-Doutorado & Doutorado/Pós-Doc/Observatori_Metropolita/Dades/2022_Habitaclia_demanda/dt=20220501", pattern="*.snappy.parquet", full.names=TRUE)
...
filenames6 <- list.files("/Users/wemigliari/Documents/Pós-Doutorado & Doutorado/Pós-Doc/Observatori_Metropolita/Dades/2022_Habitaclia_demanda/dt=20220601", pattern="*.snappy.parquet", full.names=TRUE)
...
filenames7 <- list.files("/Users/wemigliari/Documents/Pós-Doutorado & Doutorado/Pós-Doc/Observatori_Metropolita/Dades/2022_Habitaclia_demanda/dt=20220701", pattern="*.snappy.parquet", full.names=TRUE)
...
filenames8 <- list.files("/Users/wemigliari/Documents/Pós-Doutorado & Doutorado/Pós-Doc/Observatori_Metropolita/Dades/2022_Habitaclia_demanda/dt=20220801", pattern="*.snappy.parquet", full.names=TRUE)
...
filenames9 <- list.files("/Users/wemigliari/Documents/Pós-Doutorado & Doutorado/Pós-Doc/Observatori_Metropolita/Dades/2022_Habitaclia_demanda/dt=20220901", pattern="*.snappy.parquet", full.names=TRUE)
...
filenames10 <- list.files("/Users/wemigliari/Documents/Pós-Doutorado & Doutorado/Pós-Doc/Observatori_Metropolita/Dades/2022_Habitaclia_demanda/dt=20221001", pattern="*.snappy.parquet", full.names=TRUE)
...
filenames11 <- list.files("/Users/wemigliari/Documents/Pós-Doutorado & Doutorado/Pós-Doc/Observatori_Metropolita/Dades/2022_Habitaclia_demanda/dt=20221101", pattern="*.snappy.parquet", full.names=TRUE)
ldf11 <- lapply(filenames11, read_parquet)
class(ldf11)
habit_demanda_nov <- as.data.frame(do.call(rbind, ldf11))
#habit_demanda_nov[which(habit_demanda_nov$property_id == "2000002300003758420"), ]
...
filenames12 <- list.files("/Users/wemigliari/Documents/Pós-Doutorado & Doutorado/Pós-Doc/Observatori_Metropolita/Dades/2022_Habitaclia_demanda/dt=20221201", pattern="*.snappy.parquet", full.names=TRUE)
ldf12 <- lapply(filenames12, read_parquet)
class(ldf12)
habit_demanda_des <- as.data.frame(do.call(rbind, ldf12))
#habit_demanda_des[which(habit_demanda_des$property_id == "2000002300003758420"), ]
...
habit_demanda_2022 <- bind_rows(habit_demanda_gener,
...
class(habit_demanda_2022)
count(habit_demanda_2022, "province")

write.csv(habit_demanda_2022, "/Users/wemigliari/Documents/Pós-Doutorado & Doutorado/Pós-Doc/Observatori_Metropolita/Dades/2022_Habitaclia_demanda/extraccions_habit_demanda_2022.csv")
