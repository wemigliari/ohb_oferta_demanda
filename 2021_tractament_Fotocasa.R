...
catalunya_noms <- read.xlsx("/Volumes/OHB/04.Laboratoris/LAB201703-Lloguer/04.Dades/Joffre_Wellington/Catalunya_noms_oficials.xlsx",
                            sheetName = "Sheet1")
#foto_ofer_2021 <- read.csv("/Users/wemigliari/Documents/Pós-Doutorado & Doutorado/Pós-Doc/Observatori_Metropolita/Dades/2021_Fotocasa_Oferta/extraccions_foto_oferta_2021.csv")

##### Data més recent i més antigua
#foto_ofer_2021 <- foto_ofer_2021 %>% group_by(property_id, mes)%>%slice(c(1,n()))
#####
...
##########################################
foto_ofer_2021 <- foto_oferta_2021
foto_ofer_2021$NOMMUNI <- foto_ofer_2021$level5

foto_ofer_2021$NOMMUNI<-gsub(" Capital","",as.character(foto_ofer_2021$NOMMUNI))
foto_ofer_2021$NOMMUNI<-gsub(" Barcelona","Barcelona",as.character(foto_ofer_2021$NOMMUNI))
foto_ofer_2021$NOMMUNI<-gsub(" Girona","Girona",as.character(foto_ofer_2021$NOMMUNI))
foto_ofer_2021$NOMMUNI<-gsub(" Lleida","Lleida",as.character(foto_ofer_2021$NOMMUNI))
foto_ofer_2021$NOMMUNI<-gsub(" Tarragona","Tarragona",as.character(foto_ofer_2021$NOMMUNI))
foto_ofer_2021$NOMMUNI<-gsub("L'Hospitalet de Llobregat","l'Hospitalet de Llobregat",as.character(foto_ofer_2021$NOMMUNI))
foto_ofer_2021$NOMMUNI<-gsub("L'Ametlla de Mar","l'Ametlla de Mar",as.character(foto_ofer_2021$NOMMUNI))
foto_ofer_2021$NOMMUNI<-gsub("L'Ametlla del Vallès","l'Ametlla del Vallès",as.character(foto_ofer_2021$NOMMUNI))
foto_ofer_2021$NOMMUNI<-gsub("El Bruc","el Bruc",as.character(foto_ofer_2021$NOMMUNI))
foto_ofer_2021$NOMMUNI<-gsub("El Brull","el Brull",as.character(foto_ofer_2021$NOMMUNI))
foto_ofer_2021$NOMMUNI<-gsub("El Vendrell","el Vendrell",as.character(foto_ofer_2021$NOMMUNI))
foto_ofer_2021$NOMMUNI<-gsub("L'","l'",as.character(foto_ofer_2021$NOMMUNI))
foto_ofer_2021$NOMMUNI<-gsub("El","el",as.character(foto_ofer_2021$NOMMUNI))
foto_ofer_2021$NOMMUNI<-gsub("La","la",as.character(foto_ofer_2021$NOMMUNI))
foto_ofer_2021$NOMMUNI[which(foto_ofer_2021$NOMMUNI=="Torrent (Girona)")] <- "Torrent"
foto_ofer_2021$NOMMUNI[which(foto_ofer_2021$NOMMUNI=="Alàs I Cerc")] <- "Alàs i Cerc"
foto_ofer_2021$NOMMUNI[which(foto_ofer_2021$NOMMUNI=="Les Avellanes i Santa Linya")] <- "les Avellanes i Santa Linya"
foto_ofer_2021$NOMMUNI[which(foto_ofer_2021$NOMMUNI=="Les Borges Blanques")] <- "les Borges Blanques"
foto_ofer_2021$NOMMUNI[which(foto_ofer_2021$NOMMUNI=="Les Borges del Camp")] <- "les Borges del Camp"
foto_ofer_2021$NOMMUNI[which(foto_ofer_2021$NOMMUNI=="Les Cabanyes")] <- "les Cabanyes"
foto_ofer_2021$NOMMUNI[which(foto_ofer_2021$NOMMUNI=="Les Franqueses del Vallès")] <- "les Franqueses del Vallès"
foto_ofer_2021$NOMMUNI[which(foto_ofer_2021$NOMMUNI=="Les Masies de Roda")] <- "les Masies de Roda"
foto_ofer_2021$NOMMUNI[which(foto_ofer_2021$NOMMUNI=="Les Masies de Voltregà")] <- "les Masies de Voltregà"
foto_ofer_2021$NOMMUNI[which(foto_ofer_2021$NOMMUNI=="Les Piles")] <- "les Piles"
foto_ofer_2021$NOMMUNI[which(foto_ofer_2021$NOMMUNI=="Les Preses")] <- "les Preses"
foto_ofer_2021$NOMMUNI[which(foto_ofer_2021$NOMMUNI=="Les Valls de Valira")] <- "les Valls de Valira"
foto_ofer_2021$NOMMUNI[which(foto_ofer_2021$NOMMUNI=="de Les")] <- "de les"
foto_ofer_2021$NOMMUNI[which(foto_ofer_2021$NOMMUNI=="l'Ametlla de Mar ")] <- "l'Ametlla de Mar"
foto_ofer_2021$NOMMUNI[which(foto_ofer_2021$NOMMUNI=="Sant Carles de la Ràpita")] <- "la Ràpita"

foto_ofer_2021$level7[which(foto_ofer_2021$level7=="Sants - Montjuïc")] <- "Sants-Montjuïc"
foto_ofer_2021$level7[which(foto_ofer_2021$level7=="Sarrià - Sant Gervasi")] <- "Sarrià-Sant Gervasi"
foto_ofer_2021$level7[which(foto_ofer_2021$level7=="Horta - Guinardò")] <- "Horta-Guinardò"
foto_ofer_2021$level7[which(foto_ofer_2021$level7=="Horta - Guinardó")] <- "Horta-Guinardò"
...
#foto_ofer_2021 <- foto_ofer_2021[,c(2, 16, 24, 26, 27, 7, 13, 5, 6, 18, 4, 3, 19, 17, 29)]
...
test11a <- foto_ofer_2021[order(foto_ofer_2021$date_posting),]
...
test111 <- join(foto_ofer_2021, test111, by = "property_id")
...
foto_oferta_2021 <- test111
foto_oferta_2021$date_posting <- as.Date(foto_oferta_2021$date_posting)

count(test111, "mitjana_superficie_mes")
count(test111, "mitjana_preu_mes")

library(xlsx)
write_csv(test111, "/Users/wemigliari/Documents/Pós-Doutorado & Doutorado/Pós-Doc/Observatori_Metropolita/Dades/2021_Fotocasa_Oferta/tractament_foto_oferta_2021.csv")
