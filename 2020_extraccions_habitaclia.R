...
filenames11 <- list.files("/Users/wemigliari/Documents/Pós-Doutorado & Doutorado/Pós-Doc/Observatori_Metropolita/Dades/2020_Habitaclia_demanda/dt=20201101", pattern="*.snappy.parquet", full.names=TRUE)
...
filenames12 <- list.files("/Users/wemigliari/Documents/Pós-Doutorado & Doutorado/Pós-Doc/Observatori_Metropolita/Dades/2020_Habitaclia_demanda/dt=20201101", pattern="*.snappy.parquet", full.names=TRUE)
